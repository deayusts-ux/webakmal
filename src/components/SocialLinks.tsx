    ...
    return (
        <div className="px-4 md:px-40 flex justify-center pb-20">
            <div className="layout-content-container flex flex-col max-w-[800px] flex-1">
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    <div className="relative flex-shrink-0 w-16 h-16 flex items-center justify-center bg-black border border-slate-700 rounded-xl shadow-lg shadow-green-900/20 group-hover:scale-110 transition-transform duration-300">
                        <svg
                            className="w-9 h-9 text-white fill-current"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="flex-1 min-w-0">
                        <h3 className="text-xl font-bold text-white mb-1 group-hover:text-[#1DB954] transition-colors">
                            Spotify
                        </h3>
                        <p className="text-slate-400 text-sm md:text-base truncate">
                    ...
                    <div className="hidden sm:flex size-10 rounded-full border border-slate-700 items-center justify-center text-slate-500 group-hover:bg-[#1DB954] group-hover:border-[#1DB954] group-hover:text-white transition-all">
                        <span className="material-symbols-outlined">arrow_outward</span>
                    </div>
                </Link>
            </div>
